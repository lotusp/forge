...
- `profiles/context/kinds/plugin.md`
...
- [ ] `plugin.md` 显式排除 logging / database-access / api-design /
...
- [ ] `testing-strategy.md` 必须含 kind 分支：plugin 输出"以 self-bootstrap
...
### T022 — 编写 3 个 plugin 专用 dimension 文件 `docs`

**描述：** 编写 plugin 专用 dimension 模板，支撑 forge 自举
