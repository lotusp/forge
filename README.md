<div align="center">
  ...
  <p>
    <a href="https://github.com/lotusp/forge/releases"><img src="https://img.shields.io/badge/version-0.4.0-blue" alt="version"/></a>
...
| `onboard` | `/forge:onboard` | Kind 驱动的项目地图生成，按 `profiles/` 组合加载（web-backend / claude-code-plugin / monorepo 等）；支持增量更新 + preserve 块 | `.forge/context/onboard.md` |
